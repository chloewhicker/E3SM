module elm_varctl
  ...
  character(len=fname_len), public :: ficephyprop  = ' '      ! ice physical properties !+CAW 
  ...
  logical, public :: use_snicar_lndice   = .false.
  logical, public :: use_snicar_lndice_varying   = .false.
