...
#include "shr_assert.h"
  ...
  use elm_varctl        , only : fsurdat, iulog, subgridflag, use_snicar_frc, use_fates, use_snicar_ad, use_snicar_lndice
...
contains
  ...
  subroutine SurfaceAlbedo(bounds,     &
    ...
    ! !USES:
      !$acc routine seq
    use elm_varctl         , only : iulog, subgridflag, use_snicar_frc, use_fates, use_snicar_ad, use_snicar_lndice
    use shr_orb_mod
