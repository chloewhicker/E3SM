...
set(FFLAGS "-mcmodel=medium -convert big_endian -assume byterecl -ftz -traceback -assume realloc_lhs -fp-model consistent -fimf-use-svml")
if (NOT DEBUG)
...
set(CXXFLAGS "-mcmodel=medium -std=c++14 -fp-model consistent")
if (compile_threaded)
